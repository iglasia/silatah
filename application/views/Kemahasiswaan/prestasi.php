...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<section class="content">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-line-chart"></i>&nbsp;&nbsp;Grafik Jumlah Prestasi per Tahun</h3>
					...
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-pie-chart"></i>&nbsp;&nbsp;Grafik Jumlah Prestasi Berdasarkan Tingkat</h3>
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								<div class="active tab-pane" id="activity">
									<h3 class="box-title">Tabel Prestasi Mahasiwa</h3>
									<!-- /.box-header -->
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($data as $dt) { ?>
												<tr>
													<td><?php echo ++$no; ?></td>
													<td hidden><?php echo $dt->idPrestasi; ?></td>
													...
													<td>
														<button class="btn btn-primary" title="Ubah Data" onclick="edit_book(<?php echo $dt->idPrestasi; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
														<button class="btn btn-danger" title="Hapus Data" onclick="delete_book(<?php echo $dt->idPrestasi; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
													</td>
												</tr>
											<?php } ?>
										</tbody>
								...
								<div class="tab-pane" id="timeline">
									...
									<a href="<?php echo base_url('Kemahasiswaan/printprestasi') ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Cetak</a>
									<h4>Data Prestasi per Prodi</h4>
									...
									<br>
									<br>
									<h4>Jumlah Kegiatan Berdasarkan Tingkat Prestasi</h4>
									<table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
										<thead>
											<th>Tingkat</th>
											<th>Jumlah</th>
			...
			<div class="modal-content">
				...
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						<input type="hidden" value="" name="idPrestasi" />
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="prestasi" id="prestasi" placeholder="Prestasi" class="form-control" type="text">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">Tingkat</label>
								<div class="col-md-9">
									<select name="tingkat" id="tingkat" class="form-control select2" style="width: 100%;">
										<option name="tingkat" value="Fakultas">Fakultas</option>
										<option name="tingkat" value="Universitas">Universitas</option>
										<option name="tingkat" value="Regional">Regional</option>
										<option name="tingkat" value="Nasional">Nasional</option>
										<option name="tingkat" value="Internasional">Internasional</option>
									</select>
								</div>
							</div>
							<div class="form-group">
	...
	<script type="text/javascript">
		...
		function edit_book(id) {
			...
			$.ajax({
				url: "<?php echo site_url('Kemahasiswaan/ajax_edit2/') ?>/" + id,
				type: "GET",
				dataType: "JSON",
				success: function(data) {

					$('[name="idPrestasi"]').val(data.idPrestasi);
					...
					$('.modal-title').text('Prestasi Mahasiswa'); // Set title to Bootstrap modal title
		...
		function save() {
			...
			if ($.trim($("#NPM").val()) === "" || $.trim($("#idProdi").val()) === "" || $.trim($("#prestasi").val()) === "" || $.trim($("#tingkat").val()) === "" || $.trim($("#tahun").val()) === "") {
				...
				if (save_method == 'add') {
					url = "<?php echo site_url('Kemahasiswaan/tambahPrestasi') ?>";
				} else {
					url = "<?php echo site_url('Kemahasiswaan/ubahPrestasi') ?>";
				}
		...
		function delete_book(id) {
			if (confirm('Are you sure delete this data?')) {
				...
				$.ajax({
					url: "<?php echo site_url('Kemahasiswaan/hapusPrestasi') ?>/" + id,
					type: "POST",
					dataType: "JSON",
					success: function(data) {
