...
<head>
	...
	<title>SILATAH | Kegiatan Mahasiswa</title>
...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<section class="content">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-line-chart"></i>&nbsp;&nbsp;Grafik Jumlah Kegiatan per Tahun</h3>
					...
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-pie-chart"></i>&nbsp;&nbsp;Grafik Jumlah kegiatan per ormawa</h3>
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								<div class="active tab-pane" id="activity">
									<h3 class="box-title">Tabel Kegiatan Mahasiwa</h3>
									<!-- /.box-header -->
                      ...
                      <button class="btn btn-success" formaction="<?php // echo base_url('Kemahasiswaan/cetak'); 
										...
										<tbody>
											...
											foreach ($data as $dt) { ?>
												<tr>
													<td><?php echo ++$no; ?></td>
													<td hidden><?php echo $dt->idKegiatan; ?></td>
													...
													<td>
														<button class="btn btn-primary" title="Ubah Data" onclick="edit_book(<?php echo $dt->idKegiatan; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
														<button class="btn btn-danger" title="Hapus Data" onclick="delete_book(<?php echo $dt->idKegiatan; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
													</td>
												</tr>
											<?php } ?>
										</tbody>
								...
								<div class="tab-pane" id="timeline">
									...
									<a href="<?php echo base_url('Kemahasiswaan/print') ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Cetak</a>
									<h4>Jumlah Kegiatan Setiap Ormawa</h4>
									...
									<br>
									<br>
									<h4>Jumlah Kegiatan Berdasarkan Tingkat Kegiatan</h4>
									<table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
										<thead>
											<th>Tingkat</th>
											<th>Jumlah</th>
									...
									<br>
									<br>
									<h4>Data Seluruh Kegiatan Mahasiswa</h4>
									<table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
										<!--  <button class="btn btn-success" formaction="<? php // echo base_url('Kemahasiswaan/cetakpdf'); 
																																			?>" type="submit"><i class="glyphicon glyphicon-plus"></i><a href="<? php // echo base_url('Kemahasiswaan/cetakpdf'); 
																																																																																													?>"><font color="white">Cetak PDF</font></a></button>&nbsp;&nbsp;&nbsp; 
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Kegiatan Mahasiswa</h3>
				</div>
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						<input type="hidden" value="" name="idKegiatan" />
						<div class="form-body">
							<div class="form-group">
								<label class="control-label col-md-3">Nama Ormawa</label>
								<div id="combox" class="col-md-9">
									<select name="namaOrmawa" required id="namaOrmawa" class="form-control select2" style="width: 100%;">
										<?php foreach ($data3 as $dt) { ?>
											<option value="<?php echo $dt['idOrmawa'] ?>"><?php echo $dt['namaOrmawa'] ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-9">
									<select name="tingkat" required id="tingkat" class="form-control select2" style="width: 100%;">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="kegiatan" id="kegiatan" required placeholder="Kegiatan" class="form-control" type="text">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="tempat" id="tempat" required placeholder="Tempat" class="form-control" type="text">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<div class="input-group date">
										...
										<input type="text" required name="waktu" class="form-control pull-right" id="datepicker">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">Dana</label>
								<div class="col-md-9">
									<input name="dana" id="dana" required placeholder="Dana" class="form-control" type="text">
	...
	<script type="text/javascript">
		...
		function save() {
			...
			if ($.trim($("#namaOrmawa").val()) === "" || $.trim($("#tingkat").val()) === "" || $.trim($("#kegiatan").val()) === "" || $.trim($("#tempat").val()) === "" || $.trim($("#datepicker").val()) === "" || $.trim($("#dana").val()) === "") {
