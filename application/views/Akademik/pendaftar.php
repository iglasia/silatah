...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<section class="content">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-pie-chart"></i>&nbsp;&nbsp;Grafik Jumlah pendaftar berdasarkan jalur masuk</h3>
					...
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-line-chart"></i>&nbsp;&nbsp;Grafik Jumlah Pendaftar per Tahun</h3>
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								<div class="active tab-pane" id="activity">
									<h3 class="box-title">Tabel Pendaftar</h3>
									<!-- /.box-header -->
									<table id="example1" class="table table-bordered table-striped">
										...
										<!-- <a href="<? php // echo base_url('Akademik/bantuan2'); 
																	?>" class="btn btn-default"><i class="glyphicon glyphicon-copy"></i>  Rekap</a>  --->
                      ...
                      <button class="btn btn-success" formaction="<?php // echo base_url('Kemahasiswaan/cetak'); 
										...
										<tbody>
											...
											foreach ($data as $dt) { ?>
												<tr>
													<td><?php echo ++$no; ?></td>
													<td hidden><?php echo $dt->idPendaftar; ?></td>
													<td><?php echo $dt->namaPendaftar; ?></td>
													<td><?php echo $dt->namaProdi; ?></td>
													<td><?php echo $dt->jalur; ?></td>
													<td><?php echo $dt->tahun; ?></td>
													<td><?php echo $dt->jenisKelamin; ?></td>
													<td>
														<button class="btn btn-primary" title="Ubah Data" onclick="edit_book(<?php echo $dt->idPendaftar; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
														<button class="btn btn-danger" title="Hapus Data" onclick="delete_book(<?php echo $dt->idPendaftar; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
													</td>
												</tr>
											<?php } ?>
										</tbody>
								...
								<div class="tab-pane" id="timeline">
									<!-- The timeline -->
									<h3 class="box-title">Data Statistik Pendaftar</h3>
									<a href="<?php echo base_url('Akademik/printPendaftar') ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Cetak</a>
									<h4>Data Pendaftar per Tahun</h4>
									...
									<br>
									<br>
									<h4>Data Pendaftar Berdasarkan Jalur Masuk</h4>
									<table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
										<thead>
											<tr>
												<th rowspan="3">No.</th>
												<th rowspan="3">Program Studi</th>
												<th colspan="10">Jalur Masuk</th>
												<th rowspan="3">Total</th>
											</tr>
											<tr>
												<th colspan="2">SNMPTN</th>
												<th colspan="2">SBMPTN</th>
												<th colspan="2">PPA/PBM</th>
												<th colspan="2">SPMU</th>
												<th colspan="2">Avirmasi</th>
											</tr>
											<tr>
												<th>L</th>
												<th>P</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Pendaftar</h3>
				</div>
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						<input type="hidden" value="" name="idPendaftar" />
						<div class="form-body">
							<div class="form-group">
								<label class="control-label col-md-3">Nama Pendaftar</label>
								<div class="col-md-9">
									<input name="namaPendaftar" id="namaPendaftar" required placeholder="Nama Pendaftar" class="form-control" type="text">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select name="jalur" required id="jalur" class="form-control select2" style="width: 100%;">
	...
	<script type="text/javascript">
		...
		function edit_book(id) {
			...
			$.ajax({
				url: "<?php echo site_url('Akademik/ajax_edit3/') ?>/" + id,
				type: "GET",
				dataType: "JSON",
				success: function(data) {

					$('[name="idPendaftar"]').val(data.idPendaftar);
					...
					$('.modal-title').text('Pendaftar'); // Set title to Bootstrap modal title
		...
		function save() {
			...
			if ($.trim($("#namaPendaftar").val()) === "" || $.trim($("#idProdi").val()) === "" || $.trim($("#jalur").val()) === "" || $.trim($("#tahun").val()) === "" || $.trim($("#jenisKelamin").val()) === "") {
				...
				if (save_method == 'add') {
					url = "<?php echo site_url('Akademik/tambahPendaftar') ?>";
				} else {
					url = "<?php echo site_url('Akademik/ubahPendaftar') ?>";
				}
		...
		function delete_book(id) {
			if (confirm('Are you sure delete this data?')) {
				...
				$.ajax({
					url: "<?php echo site_url('Akademik/hapusPendaftar') ?>/" + id,
					type: "POST",
					dataType: "JSON",
					success: function(data) {
	...
	<script>
		$(function() {
			...
			var lineChartData = {
				labels: [<?php foreach ($data7 as $data2) {
										echo "'" . $data2['tahun'] . "',";
									} ?>],
				datasets: [{
					...
					data: [<?php foreach ($data7 as $data2) {
										echo $data2['jumlah'] . ',';
									} ?>]
				}]
			}
