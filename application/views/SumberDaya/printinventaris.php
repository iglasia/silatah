	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<!-- <img src="<?php //echo base_url('assets/dist/img/logounib.png'); 
												?>" width="130" height="130" style="float:left;margin-right:-100;">
    <center>
      <h5>KEMENTRIAN RISET, TEKNOLOGI DAN PENDIDIKAN TINGGI</h5>
      <h4>UNIVERSITAS BENGKULU<br>FAKULTAS TEKNIK<br></h4>
					...
					<form action="#" id="form" class="form-horizontal">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="tahun" id="tahun" placeholder="Tahun" required class="form-control" type="text">
