...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<div class="col-md-6">
						...
						<div class="box box-header">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fa fa-pie-chart"></i>&nbsp;&nbsp;Grafik Jumlah Dosen per prodi</h3>
							...
							<div class="tab-content">
								<div class="active tab-pane" id="activity">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<a href="<?php echo base_url('Sumberdaya/bantuan'); ?>" title="Rekap Data" class="btn btn-default"><i class="glyphicon glyphicon-copy"></i></i> Rekap</a>
                      ...
                      <button class="btn btn-success" formaction="<?php // echo base_url('Kemahasiswaan/cetak'); 
										...
										<tbody>
											...
											foreach ($data as $dt) { ?>
												<tr>
													<td><?php echo ++$no; ?></td>
													<td hidden><?php echo $dt->idDosen; ?></td>
													<td><?php echo $dt->NIP; ?></td>
													<td><?php echo $dt->namaDosen; ?></td>
													...
													<td>
														<button class="btn btn-primary" title="Ubah Data" onclick="edit_book(<?php echo $dt->idDosen; ?>)"><i class="glyphicon glyphicon-pencil"></i></button>
														<button class="btn btn-danger" title="Hapus Data" onclick="delete_book(<?php echo $dt->idDosen; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
													</td>
												</tr>
											<?php } ?>
										</tbody>
								...
								<div class="tab-pane" id="timeline">
									<!-- The timeline -->
									<h3 class="box-title">Data Statistik Dosen</h3>
									<a href="<?php echo base_url('Sumberdaya/printDosen') ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Cetak</a>
									<h4>Data Dosen Berdasarkan Golongan</h4>
									<table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
										<thead>
											<tr>
												<th rowspan="3">No.</th>
												<th rowspan="3">Program Studi</th>
												<th colspan="10">Golongan</th>
									...
									<br>
									<br>
									<h4>Data Dosen Berdasarkan Jenis Kelamin</h4>
									<table class="table table-bordered" style="border-collapse: collapse; width: 100%; margin: 0 auto;">
										<thead>
											<tr>
												<th rowspan="3">No.</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Dosen</h3>
				</div>
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						<input type="hidden" value="" name="idDosen" />
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="namaDosen" id="namaDosen" required placeholder="Nama Dosen" class="form-control" type="text">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select name="jabatan" required id="jabatan" class="form-control select2" style="width: 100%;">
	...
	<script type="text/javascript">
		...
		function edit_book(id) {
			...
			$.ajax({
				url: "<?php echo site_url('Sumberdaya/ajax_edit2/') ?>/" + id,
				type: "GET",
				dataType: "JSON",
				success: function(data) {
					...
					$('[name="namaDosen"]').val(data.namaDosen);
					...
					$('.modal-title').text('Dosen'); // Set title to Bootstrap modal title
		...
		function save() {
			...
			if ($.trim($("#NIP").val()) === "" || $.trim($("#namaDosen").val()) === "" || $.trim($("#jenisKelamin").val()) === "" || $.trim($("#idProdi").val()) === "" || $.trim($("#jabatan").val()) === "" || $.trim($("#jenjangPendidikan").val()) === "" || $.trim($("#golongan").val()) === "") {
				...
				if (save_method == 'add') {
					url = "<?php echo site_url('Sumberdaya/tambahDosen') ?>";
				} else {
					url = "<?php echo site_url('Sumberdaya/ubahDosen') ?>";
				}
		...
		function delete_book(id) {
			if (confirm('Are you sure delete this data?')) {
				...
				$.ajax({
					url: "<?php echo site_url('Sumberdaya/hapusDosen') ?>/" + id,
					type: "POST",
					dataType: "JSON",
					success: function(data) {
